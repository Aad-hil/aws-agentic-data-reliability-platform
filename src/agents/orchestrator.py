...
class ReliabilityWorkflowResult:
    """Complete state produced by the multi-agent workflow."""
...
class ReliabilityOrchestrator:
    """Coordinate detection, RCA, and recommendation agents in order."""
    ...
    def run(
        ...
        *,
        ...
        return ReliabilityWorkflowResult(
            incident=incident,
            rca=rca,
            recommendation=recommendation,
        )
